<template>
  <body>
      ...
      <div class="main-menu-inner" id="sidebar">
        ...
        <div class="topbar-left">
          <a href="../crm/crm-index.html" class="logo">
            <span>
              <img src="../assets/images/octomoda.png" alt="logo-large" class="logo-lg logo-dark"/> OCTOMODA
            </span>
          </a>
        </div>
        <!--end logo-->
        <div class="menu-body slimscroll">
          ...
          <div id="MetricaApps" class="main-icon-menu-panel">
            ...
            <ul class="nav metismenu">
              <li class="nav-item">
                <a class="nav-link" href="#"><i class="mdi mdi-view-dashboard-outline"></i> Dashboard</a>
              </li>
              <li class="nav-item">
              ...
              <!--end nav-item-->
              <li class="nav-item">
                <router-link class="nav-link" to="/profile"><i class="mdi mdi-account-edit"></i> Profile</router-link>
              </li>
            </ul>
          </div>
        </div>
    ...
    <div class="modaladd" id="tambahuser">
      <div class="cardmodal">
        <div class="headermodal">
          <h3>Tambah Agenda</h3>
          <i class="mdi mdi-window-close closemodal" @click="closemodal"></i>
